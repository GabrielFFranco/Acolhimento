 ...
 * @author Aluno
 */
public class MenuEncaminhamento extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public MenuEncaminhamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblInserirFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/Encaminhamento+.png"))); // NOI18N
        ...
        lblBuscarFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/ENCAMINHAMENTOBUSCAR.jpg"))); // NOI18N
    ...
    InserirEncaminhamentoView tela = new InserirEncaminhamentoView(new javax.swing.JDialog(), true);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuEncaminhamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuEncaminhamento().setVisible(true);
            }
        });
    }
